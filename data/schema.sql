...
CREATE TABLE IF NOT EXISTS apt_events (
    ...
    ip_address TEXT,
    session_id INT  -- populated later by session_builder via UPDATE
);
...
-- ===============================
-- RATE-LIMITS TABLE (OUTPUT)
-- ===============================
CREATE TABLE IF NOT EXISTS apt_rate_limits (
    session_id  INT PRIMARY KEY REFERENCES apt_sessions(session_id),
    applied_at  TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    active      BOOLEAN DEFAULT TRUE,
    max_qps     INT DEFAULT 5
);
